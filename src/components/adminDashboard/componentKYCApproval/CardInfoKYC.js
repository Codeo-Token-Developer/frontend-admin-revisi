        ...
        <ModalBody>
          <table className="table table-responsive">
            <tr>
              ...
              <td>
                <a
                  href={props.data.document_image}
                  alt="kycFile"
        ...
        <ModalFooter>
          {props.data.approved_status === true ? (
            <Button
              ...
              onClick={() =>
                RejectKYC({ idKyc: props.data._id, userId: props.data.user })
              }
            >
              Reject KYC
            </Button>
            ...
            <Button
              ...
              onClick={() =>
                ApprovalKYC({ idKyc: props.data._id, userId: props.data.user })
              }
            >
              Approve KYC
            </Button>
          ...
          {props.data.lock_status === true ? (
            <Button
              color="light"
              className="text-danger"
              onClick={() => UnlockKYC(props.data._id)}
            >
              Unlock KYC
            </Button>
            ...
            <Button
              color="light"
              className="text-success"
              onClick={() => LockedKYC(props.data._id)}
            >
              Lock KYC
            </Button>
          ) : null}
