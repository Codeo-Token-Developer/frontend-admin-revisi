...
import {
    Alert,Modal,ModalBody,ModalHeader,ModalFooter,InputGroup,Input,InputGroupAddon
} from "reactstrap";
    ...
    return (
      <>
        <div className="row card text-center">
                    ...
                    <table className="table table-borderless border border-light">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <button style={{"cursor":"pointer"}} onClick={()=>togglemdModal("BTC")} className="btn btn-default text-success m-2">Add Balance</button>
            ...
            <ModalBalance fAddBalance={fAddBalance} numberAmount={numberAmount} amountBalance={amountBalance} mdModal={mdModal} togglemdModal={togglemdModal} />
            </>
    );
    }
}
...
function ModalBalance(props){
  ...
  return (
    <>
    <Modal isOpen={props.mdModal} toggle={props.togglemdModal}>
      <ModalHeader className="fa fa-money" toggle={props.togglemdModal}>
          Add Balance
      </ModalHeader>
      <ModalBody>
